...
public class MsSql2008JDBCConnection extends JDBCConnection<MsSql2008JDBCDataSource, MsSql2008Dbms>
{
	public MsSql2008JDBCConnection(MsSql2008JDBCDataSource dataSource)
	{
		super(dataSource);
	}
