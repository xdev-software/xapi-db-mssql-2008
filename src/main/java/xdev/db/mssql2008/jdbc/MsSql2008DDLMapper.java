...
public class MsSql2008DDLMapper extends StandardDDLMapper<MsSql2008Dbms>
{
	...
	/**
	 * Instantiates a new ms sql2008 ddl mapper.
	 * 
	 * @param dbmsAdaptor
	 *            the dbms adaptor
	 */
	protected MsSql2008DDLMapper(final MsSql2008Dbms dbmsAdaptor)
	{
		super(dbmsAdaptor);
	}
	 ...
	 * @return
	 * @see com.xdev.jadoth.sqlengine.dbms.DbmsDDLMapper.Implementation#mapIndexType(java.lang.String)
	 */
	@Override
	 ...
	 * @return the string
	 * @return
	 * @see com.xdev.jadoth.sqlengine.dbms.DbmsDDLMapper.Implementation#lookupDdbmsDataTypeMapping(com.xdev.jadoth.sqlengine.SQL.DATATYPE,
